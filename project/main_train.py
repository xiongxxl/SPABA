...
label_excel = os.path.join(label_folder, 'uspto_yang_reactive_atom_orgin_50k_indices_atoms_deep_ruizhen.xlsx')
...
img_path=(f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{drop}_weight_delay_'
          f'{weight_decay}_head_{head}_attn_{attn}_best_val_dacc_{best_val_dacc}_loss.jpg')
...
result_folder = os.path.join(parent_dir, result_file_name)
img_path=(f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{drop}_weight_delay_'
          f'{weight_decay}_head_{head}_attn_{attn}_best_val_acc_{best_val_mcc}_MCC_52.jpg')
sample_file=os.path.join(result_folder,img_path)
plt.savefig(sample_file)
para_path=(f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{drop}_weight_delay_'
           f'{weight_decay}_head_{head}_attn_{attn}_best_val_acc_{best_val_mcc}_MCC_52.pth')
...
result_folder = os.path.join(parent_dir, result_file_name)
img_path=(f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{drop}_weight_delay_'
          f'{weight_decay}_head_{head}_attn_{attn}_best_val_acc_{best_val_dacc}_DACC_52.jpg')
sample_file=os.path.join(result_folder,img_path)
plt.savefig(sample_file)
para_path=(f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{drop}_weight_delay_'
           f'{weight_decay}_head_{head}_attn_{attn}_best_val_acc_{best_val_dacc}_DACC_52.pth')
para_file=os.path.join(result_folder,para_path)
...
result_folder = os.path.join(parent_dir, result_file_name)
img_path=(f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{drop}_weight_delay_'
          f'{weight_decay}_head_{head}_attn_{attn}_best_val_acc_{best_val_sacc}_SACC_52.jpg')
sample_file=os.path.join(result_folder,img_path)
plt.savefig(sample_file)
para_path=(f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{drop}_weight_delay_'
           f'{weight_decay}_head_{head}_attn_{attn}_best_val_acc_{best_val_sacc}_SACC_52.pth')
para_file=os.path.join(result_folder,para_path)
