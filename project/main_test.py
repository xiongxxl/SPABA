...
sample_file_name= f'data/middle_attention/npy_supervision/uspto/attention'
sample_file=os.path.join(parent_dir,sample_file_name)
label_file_name = f'data/result/statistics_supervision/uspto//{head}/label'
...
result_file_name = f'data/result/statistics_supervision/{head}/result/{save_name}'
result_folder = os.path.join(parent_dir, result_file_name)
para_path=f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{dropout}_weight_delay_{weight_decay}_head_{head}_attn_{attn}_best_val_mcc_{best_val_mcc}.pth'
...
path_excel_metrics=f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{dropout}_weight_delay_{weight_decay}_head_{head}_attn_{attn}_best_val_mcc_{best_val_mcc}_metrics.xlsx'
...
path_excel_atoms=f'network_{network}_batch_{batch_size}_epochs_{epochs}_learn_rate_{learn_rate}_drop_{dropout}_weight_delay_{weight_decay}_head_{head}_attn_{attn}_best_val_mcc_{best_val_mcc}_atoms.xlsx'
