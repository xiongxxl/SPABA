...
if __name__=="__main__":
    ...
    # ##single sample
    # df_criterion_smiles='CS[C@]([C@@](C)C(=O)O)[C@@H]1CCCN1C(=O)OC(C)(C)C.NCCc1cccc(O)c1'
...
# deal with excel
    ...
    df_criterion=pd.read_excel('uspto_ruizhen_product.xlsx')
    ...
    df_criterion.to_excel('uspto_ruizhen_product_deep.xlsx')
