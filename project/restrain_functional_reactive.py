...
if __name__ == "__main__":
    smiles = "C[C@](N)C(O)=O.O=C(C)OC(C)=O.N.N#CS"
    reactive_atoms = [4, 5, 6, 7]
    results,reactive_atoms_restrain_result=restrain_functional_axis_single(smiles, reactive_atoms)

    print('fucntional_arrays:',results)
    print('fucntional_arrays:',reactive_atoms_restrain_result)
