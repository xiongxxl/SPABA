...
if __name__=="__main__":
    #
    ##single sample
    df_criterion_smiles='ClC1=CC=C(OC)C=C1.FC3=CC=C(B(O)O)C=C3.[O-][N+]2(C)CCOCC2'
    df_criterion_label=[0,1,9,10,21,22]
...
## deal with excel
    ...
    # excel_path='uspto_ruizhen_product_deep_img.xlsx'
    ...
    # excel_output_path='uspto_ruizhen_product_deep_img_deep.xlsx'
