...
class MultiheadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, kdim=None, vdim=None, dropout=0., bias=True,
                 add_bias_kv=False, add_zero_attn=False, self_attention=True,
    ...
    def forward(
        ...
        attn_twodim_first = attn[0]
        attn_array_first = attn_twodim_first.detach().numpy()

        global t
        t=0
        filename=f"attn_array_first_{t}.npy"
        np.save(filename,attn_array_first )
        t = t + 1
        print('t',t)
