...
class RobertaEncoder(FairseqDecoder):
    ...
    def forward(self, src_tokens, features_only=False, return_all_hiddens=True, masked_tokens=None, mask_matrix=None, **unused):
        """
        Args:
        ...
        """
        x, extra, attn, attn_8head = self.extract_features(src_tokens, return_all_hiddens=return_all_hiddens, mask_matrix=mask_matrix)

        if not features_only:
            x = self.output_layer(x, masked_tokens=masked_tokens)
        return x, extra, attn, attn_8head

    def extract_features(self, src_tokens, return_all_hiddens=False, mask_matrix=None, **unused):
